                            ...
                            <div key={item.name} className="relative -top-6">
                                <Link href={item.href}>
                                    <div className={cn(
                                        ...
                                        "bg-gradient-to-br from-red-600 to-rose-600 text-white shadow-red-500/30 border-4 border-white/50 dark:border-gray-900/50 backdrop-blur-sm"
                                    )}>
                                        <Icon className="w-8 h-8" />
                                    </div>
                                </Link>
                                <span className="absolute -bottom-6 left-1/2 transform -translate-x-1/2 text-[10px] font-bold text-red-600 dark:text-red-500 drop-shadow-sm">
                                    {item.name}
                                </span>
                            </div>
                        );
