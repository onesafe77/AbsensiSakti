        ...
        mutationFn: async ({ sessionId, files }: { sessionId: string; files: File[] }) => {
            ...
            try {
                ...
                for (const file of files) {
                    const urlResponse = await fetch(`/api/sidak-workshop/${sessionId}/request-upload-url`, {
                        method: 'POST',
                    ...
                    const confirmResponse = await fetch(`/api/sidak-workshop/${sessionId}/confirm-upload`, {
                        method: 'POST',
                        headers: { 'Content-Type': 'application/json' },
                ...
                <div className="flex items-center gap-3 pt-2">
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2">
                            <Wrench className="h-6 w-6 text-red-600 flex-shrink-0" />
                                    ...
                                    <div className="bg-gray-50 dark:bg-gray-700/30 rounded-lg p-3 mb-4">
                                        <div className="space-y-1">
                                            <div className="flex items-center gap-1.5 text-red-600 dark:text-red-400">
                                                ...
                                                <span className="text-[10px] uppercase font-bold tracking-wider">Departemen</span>
                                            </div>
