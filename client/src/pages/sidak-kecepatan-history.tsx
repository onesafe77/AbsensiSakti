                ...
                {isLoading ? (
                    ...
                    <div className="space-y-3">
                        {sessions.map((session) => (
                            <Card
                                key={session.id}
                                className="overflow-hidden border border-red-200 dark:border-red-800 shadow-sm"
                            >
                                <CardContent className="p-4">
                                    <div className="flex items-start justify-between gap-2 mb-3">
                                        ...
                                        <Badge variant="outline" className="bg-red-50 text-red-700 text-xs flex-shrink-0">
                                    ...
                                    <div className="grid grid-cols-2 gap-2 text-xs mb-3">
                                        ...
                                        <div>
                                            <div className="flex items-center gap-1 text-red-600 mb-0.5">
                                                ...
                                                <span className="font-medium">Batas Max</span>
                                            </div>
                                            <p className="text-gray-600 truncate">{session.batasKecepatanKph} KM/H</p>
                                        </div>
                                    </div>
